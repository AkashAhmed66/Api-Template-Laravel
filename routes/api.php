...
Route::middleware(['throttle:api-300'])->group(function () {
    ...
    Route::get('get-notification-count/userId/{userId}', [NotificationQueueController::class, 'getNotification']); 
    Route::post('flush-notification-count', [NotificationQueueController::class, 'flushNotofication']); 
